...
class BarGraphDiaryMultiV2 extends StatefulWidget {

  final List<dynamic> allData;

  const BarGraphDiaryMultiV2({super.key, required this.allData});



  @override

  State<BarGraphDiaryMultiV2> createState() => _BarGraphDiaryMultiV2State();

}



class _BarGraphDiaryMultiV2State extends State<BarGraphDiaryMultiV2> {
  ...
  void didUpdateWidget(covariant BarGraphDiaryMultiV2 oldWidget) {
