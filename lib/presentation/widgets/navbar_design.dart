      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            items('WUR', indexScreenProvider, context, 0),
            const SizedBox(height: 20,),
            items('Pozos', indexScreenProvider, context, 1),
            const SizedBox(height: 20,),
            items('Manifold',indexScreenProvider, context,2),
            const SizedBox(height: 20,),
            items('Estaciones CIP', indexScreenProvider, context, 3),
            const SizedBox(height: 20,),
            items('Ósmosis', indexScreenProvider, context, 4),
            const SizedBox(height: 20,),
            items('Filtros Pulidores', indexScreenProvider, context, 5),
            const SizedBox(height: 20,),
            items('Lavadoras', indexScreenProvider, context, 6),
            Spacer(),
