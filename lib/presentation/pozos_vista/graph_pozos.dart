...
class GraphPozos extends StatefulWidget {
  final List<dynamic> pozosData;
  const GraphPozos({super.key, required this.pozosData});

  @override
  State<GraphPozos> createState() => _GraphPozosState();
}

class _GraphPozosState extends State<GraphPozos> {
  ...
  @override
  void didUpdateWidget(covariant GraphPozos oldWidget) {
  ...
  void _prepararDatos(){
    _sortedData = List.from(widget.pozosData);
